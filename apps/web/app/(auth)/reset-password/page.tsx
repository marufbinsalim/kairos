            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider">Recovery phrase</label>
                  <button
                    type="button"
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 text-white text-sm placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-colors resize-none font-mono"
                  placeholder="word1 word2 word3 ... word12"
                  required
                />
                <p className="text-xs text-gray-600 mt-1">Enter all 12 words separated by spaces, or upload your recovery file.</p>
              </div>
