      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <section className="py-20 md:py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="#install" className="text-gray-400 hover:text-white transition-colors font-medium px-6 py-3 w-full sm:w-auto text-center">
              Install CLI →
            </a>
          </div>
        </section>
        ...
        <section id="install" className="pb-20">
          ...
          <p className="text-gray-400 mb-6">One command — detects your OS and architecture automatically.</p>
          ...
          <p className="text-gray-500 text-sm mb-8">No sudo required. Installs to <code className="text-gray-400">~/.local/share/kairos</code> and adds to PATH automatically.</p>
        ...
        <section className="pb-24 text-center">
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 md:p-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/login" className="text-gray-400 hover:text-white transition-colors font-medium px-6 py-3 w-full sm:w-auto text-center">
                Sign in →
              </Link>
            </div>
          </div>
